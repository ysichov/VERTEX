CLASS zcl_vx_pivot DEFINITION PUBLIC CREATE PUBLIC.
  PUBLIC SECTION.
    TYPES: BEGIN OF t_val,
           ...
           "and the transpose in zcl_vx_tools=>execute_pivot
           BEGIN OF t_sqlcol,
    ...
    CLASS-METHODS:
      is_numeric_field IMPORTING i_key        TYPE string
                                 it_fields    TYPE zif_vx_pivot_types=>tt_jfld
    ...
    METHODS:
      ...
      "the cross as plain data, so a layout file can carry it (zcl_vx_tools=>save_config)
      ...
      render_panel IMPORTING it_fields      TYPE zif_vx_pivot_types=>tt_jfld
      ...
      handle_action IMPORTING i_act     TYPE string
                              it_fields TYPE zif_vx_pivot_types=>tt_jfld OPTIONAL,
      ...
      normalize_aggs IMPORTING it_fields TYPE zif_vx_pivot_types=>tt_jfld,
  ...
  PRIVATE SECTION.
    ...
    METHODS:
      ...
      zone_html IMPORTING i_zone         TYPE string
                ...
                RETURNING VALUE(rv_html) TYPE string,
      vals_html IMPORTING it_fields      TYPE zif_vx_pivot_types=>tt_jfld
                          i_show_texts   TYPE abap_bool
                RETURNING VALUE(rv_html) TYPE string,
...
CLASS zcl_vx_pivot IMPLEMENTATION.
