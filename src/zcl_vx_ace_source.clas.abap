CLASS zcl_vx_ace_source DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS parse
      ...
      RETURNING VALUE(rs_source) TYPE zif_vx_ace_parse_data=>ts_parse_data.

ENDCLASS.


CLASS zcl_vx_ace_source IMPLEMENTATION.
  ...
  METHOD parse.
    " ZCL_VX_ACE_METRICS aggregates every parsed include whose program is the one
    ...
    zcl_vx_ace_parser=>parse( EXPORTING i_program = i_program
                                     i_include = i_program
