...
- Проверка на `https://172.16.31.15:44300`: при разрешённом сертификате TLS проходит и сервер отвечает HTTP 401 без пароля; при строгой проверке воспроизводится `CERT_HAS_EXPIRED`.
